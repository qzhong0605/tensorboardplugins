 ...
 *   <g class='core'>
 *     <g class='edges'>
 *       ... stuff from tf.graph.edit.scene.edges.build ...
 *     </g>
 *     <g class='nodes'>
 *       ... stuff from tf.graph.edit.scene.nodes.build ...
 *     </g>
 *   </g>
 *   <g class='in-extract'>
 *     <g class='nodes'>
...
export function addHealthPill(
  ...
  if (nodeInfo != null && nodeInfo.node.type === tf.graph.edit.NodeType.OP) {
