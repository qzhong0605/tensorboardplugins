 ...
 *   Object with min level of the template and an Array of tf.graph.edit.Group]
 *   sort by ascending order of minimum depth at which metanode appears.
 */
function clusterSimilarSubgraphs(h: hierarchy.Hierarchy) {
  /** a dict from metanode.signature() => Array of tf.graph.edit.Groups */
...
function isSimilarSubgraph(g1: graphlib.Graph<any, any>,
  ...
  if (!tf.graph.edit.hasSimilarDegreeSequence(g1, g2)) {
      return false;
  }
