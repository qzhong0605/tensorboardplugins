 ...
 *   <g class='core'>
 *     <g class='edges'>
 *       ... stuff from tf.convert.scene.edges.build ...
 *     </g>
 *     <g class='nodes'>
 *       ... stuff from tf.convert.scene.nodes.build ...
 *     </g>
 *   </g>
 *   <g class='in-extract'>
 *     <g class='nodes'>
 ...
 * @param sceneElement <tf-convert-scene> polymer element.
...
export function addHealthPill(
  ...
  if (nodeInfo != null && nodeInfo.node.type === tf.convert.NodeType.OP) {
